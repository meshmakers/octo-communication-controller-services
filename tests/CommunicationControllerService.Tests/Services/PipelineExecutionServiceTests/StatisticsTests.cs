...
internal class StatisticsTests : PipelineExecutionServiceTestsBase
{
    ...
    public async Task UpdateStatisticsAsync_ValidPipeline_UpdatesAllPeriods()
    {
        ...
        // AB#4924: StartedAt is nullable since System.Communication 4.0.0. Every execution
        // in this fixture is started, so Nullable<DateTime>.Compare keeps the previous
        // ordering exactly; it just has to be spelled explicitly now.
        executionsLast30Days.Sort((a, b) => Nullable.Compare(b.StartedAt, a.StartedAt));
